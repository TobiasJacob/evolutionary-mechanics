...
SRC = src/Field.cpp src/Matrix.cpp src/Equation.cpp src/PerformanceEvaluator.cpp src/EvolutionaryOptimizator.cpp src/SparseMatrix.cpp src/Microtime.cpp src/plotting/Plotter.cpp
